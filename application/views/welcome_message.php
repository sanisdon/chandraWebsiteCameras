...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo base_url("assets/img/cctv.png"); ?>" rel="icon">
        ...
        <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="carousel-container">
                    <h2 class="animate__animated animate__fadeInDown">Welcome to <span>vinayaka</span>
                        <br><small>security
                            services </small>
                    </h2>
                    <p class="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid.
                        ...
                        modi architecto.</p>
                    <a href="https://www.google.com/" class="btn-get-started animate__animated animate__fadeInUp">Read
                        More</a>
                </div>
            </div>
    ...
    <main id="main">
        ...
        <section class="services">
            <div class="container">
                <div class="row">
                    <?php for ($i = 0; $i < 20; $i++) { ?>
                    <div class="col-md-4 col-lg-2 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="icon-box icon-box-blue">
                            <img src="assets/img/three.jpg" class="img-fluid" alt="">
                            <h4 class="title"><a href="">camera</a></h4>
                            <p class="description">type of camera</p>
                        </div>
                    </div>
                    <?php  } ?>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 video-box">
                        <img src="assets/img/three.jpg" class="img-fluid" alt="">
                        <a href="https://www.youtube.com/watch?v=gO3tiBwP8hw" class="venobox play-btn mb-4"
        ...
        <section class="features">
            <div class="container">
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-md-5">
                        <img src="assets/img/key.jpg" width="450" height="350">
                    </div>
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-md-5 order-1 order-md-2">
                        <img src="assets/img/second.jpg" class="img-fluid" alt="" width="450" height="350">
                    </div>
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-md-5">
                        <img src="assets/img/test123.jpg" class="img-fluid" alt="" width="450" height="350">
                    </div>
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-md-5 order-1 order-md-2">
                        <img src="assets/img/four.jpg" class="img-fluid" alt="" width="450" height="350">
                    </div>
                    <div class="col-md-7 pt-5 order-2 order-md-1">
